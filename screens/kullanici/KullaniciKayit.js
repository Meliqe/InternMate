...
export default function KullaniciKayit({ navigation }) {
    ...
    const handleRegister = async () => {
        ...
        try {
            ...
            await setDoc(doc(firestore, 'users2', user.uid), {
                email: email,
    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            <View style={styles.container}>
                ...
                <Image style={styles.logo} source={require('../../assets/kullanicikayit.png')} />
                <TextInput
                    style={styles.input}
                    placeholder="E-mail"
